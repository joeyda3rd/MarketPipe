...
def main():
    ...
    parser.add_argument(
        "--range-days", type=int, default=5, help="Number of days to include in range (default: 5)"
    )
    parser.add_argument(
        "--recent", action="store_true", help="Calculate a recent date range (last 30 days)"
    )
