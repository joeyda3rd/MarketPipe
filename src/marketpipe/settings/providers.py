...
class IEXSettings(BaseSettings):
    ...
    mp_secret_token: Optional[str] = Field(None, alias="MP_IEX_SECRET_TOKEN", description="IEX secret token")
    mp_pub_token: Optional[str] = Field(None, alias="MP_IEX_PUB_TOKEN", description="IEX publishable token")
    
    base_url: str = Field(
        default="https://cloud.iexapis.com/stable",
        description="IEX Cloud API base URL"
    )
...
class AlphaVantageSettings(BaseSettings):
    ...
    base_url: str = Field(default="https://www.alphavantage.co", description="Alpha Vantage API base URL")
...
class MarketStackSettings(BaseSettings):
    ...
    base_url: str = Field(default="http://api.marketstack.com", description="MarketStack API base URL")
...
class IntrinioSettings(BaseSettings):
    ...
    base_url: str = Field(default="https://api-v2.intrinio.com", description="Intrinio API base URL")
...
class CMEDataMineSettings(BaseSettings):
    ...
    username: str = Field(..., alias="MP_CME_DATAMINE_USERNAME", description="CME DataMine username")
    password: str = Field(..., alias="MP_CME_DATAMINE_PASSWORD", description="CME DataMine password")
    base_url: str = Field(default="https://datamine.cmegroup.com", description="CME DataMine base URL")
...
class YFinanceSettings(BaseSettings):
    ...
    base_url: str = Field(default="https://query1.finance.yahoo.com", description="Yahoo Finance base URL")
