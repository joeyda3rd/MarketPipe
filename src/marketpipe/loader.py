...
from .security.mask import safe_for_log
...
def load_ohlcv(
    ...
    *,
    ...
    logger.debug(f"Loading {symbols} from {timeframe} timeframe, "
    ...
    try:
        ...
        for symbol in symbols:
            symbol_df = _load_symbol_data(con, root, symbol, timeframe, start_ns, end_ns, is_multi_symbol)
