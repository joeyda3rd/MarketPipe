...
def test_duckdb_sql_execution():
    ...
    assert first_bar['close'] == 104.5 # Last close from bars 0-4 (100.5, 101.5, 102.5, 103.5, 104.5)
    ...
    assert second_bar['close'] == 109.5 # Last close from bars 5-9 (105.5, 106.5, 107.5, 108.5, 109.5)
