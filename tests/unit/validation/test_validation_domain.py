...
def test_validation_detects_zero_prices():
    ...
    bars = [_bar(60_000_000_000, open_price=0.001, high_price=0.001, low_price=0.001, close_price=0.001)]
...
def test_validation_detects_extreme_price_movements():
    ...
    bars = [
        _bar(60_000_000_000, open_price=100.0, high_price=100.0, low_price=100.0, close_price=100.0),
        _bar(120_000_000_000, open_price=200.0, high_price=200.0, low_price=200.0, close_price=200.0),  # 100% increase
    ]
...
def test_validation_detects_zero_volume_with_price_movement():
    ...
    bars = [_bar(60_000_000_000, open_price=100.0, high_price=101.0, low_price=100.0, close_price=101.0, vol=0)]
...
def test_validate_price_reasonableness():
    ...
    high_price_bar = _bar(60_000_000_000, open_price=150_000.0, high_price=150_000.0, low_price=150_000.0, close_price=150_000.0)
    ...
    low_price_bar = _bar(60_000_000_000, open_price=0.005, high_price=0.005, low_price=0.005, close_price=0.005)
...
def test_ohlc_consistency_validation_in_domain_service():
    ...
    valid_bar = _bar(60_000_000_000, open_price=100.0, high_price=101.0, low_price=99.0, close_price=100.5)
