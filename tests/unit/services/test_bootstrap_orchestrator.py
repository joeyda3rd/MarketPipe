...
class TestComparisonOldVsNewBootstrapTesting:
    ...
    def test_old_approach_with_mocks(self):
        ...
        with patch('marketpipe.bootstrap.apply_pending_alembic') as mock_alembic, \
             ...
             patch('marketpipe.infrastructure.monitoring.domain_event_handlers.register_logging_handlers') as mock_log:
    ...
    def test_new_approach_with_fakes(self):
        ...
        """
        orchestrator = create_fake_bootstrap_orchestrator(
            database_path=Path("business_db.db")
        )
