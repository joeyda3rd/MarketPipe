...
class TestSymbolViews:
    ...
    def _setup_symbols_master_table(self, conn: duckdb.DuckDBPyConnection, rows: list[dict]) -> None:
    ...
    def test_history_contains_all(self, fixture_master: list[dict]) -> None:
        ...
        assert history_count == master_count, "v_symbol_history should mirror symbols_master row count"
    ...
    def test_view_idempotence(self, fixture_master: list[dict]) -> None:
        ...
        assert first_history_count == second_history_count, "v_symbol_history count should be stable"
    ...
    def test_sql_file_path_resolution(self) -> None:
        ...
        try:
            ...
            assert False, "SQL file should exist"
        except RuntimeError as e:
            assert "symbols_master table not found" in str(e), "Should fail on missing table, not missing file"
