...
class TestSCDWriter:
    ...
    def test_first_load_creates_initial_records(self, empty_db, temp_data_dir, sample_snapshot_data):
    ...
    def test_second_load_handles_updates(self, empty_db, temp_data_dir, sample_snapshot_data):
        ...
        assert old_aapl["valid_to"].iloc[0].date() == dt.date(2024, 1, 15)  # closed on snapshot_date - 1
    ...
    def test_id_sequence_continuity(self, empty_db, temp_data_dir):
        ...
        # First load
        initial_data = [
            {"natural_key": "A-NASDAQ", "symbol": "A", "company_name": "Company A", 
             "exchange": "NASDAQ", "asset_type": "stock", "status": "active",
             "market_cap": 1000000, "sector": "Tech", "industry": "Software",
             "country": "US", "currency": "USD", "as_of": dt.date(2024, 1, 15)},
            {"natural_key": "B-NASDAQ", "symbol": "B", "company_name": "Company B",
             "exchange": "NASDAQ", "asset_type": "stock", "status": "active", 
             "market_cap": 2000000, "sector": "Finance", "industry": "Banking",
             "country": "US", "currency": "USD", "as_of": dt.date(2024, 1, 15)}
        ]
        ...
        new_data = initial_data + [
            {"natural_key": "C-NASDAQ", "symbol": "C", "company_name": "Company C",
             "exchange": "NASDAQ", "asset_type": "stock", "status": "active",
             "market_cap": 3000000, "sector": "Healthcare", "industry": "Biotech", 
             "country": "US", "currency": "USD", "as_of": dt.date(2024, 1, 16)},
            {"natural_key": "D-NASDAQ", "symbol": "D", "company_name": "Company D",
             "exchange": "NASDAQ", "asset_type": "stock", "status": "active",
             "market_cap": 4000000, "sector": "Energy", "industry": "Oil & Gas",
             "country": "US", "currency": "USD", "as_of": dt.date(2024, 1, 16)}
        ]
    ...
    def test_no_changes_scenario(self, empty_db, temp_data_dir):
        ...
        """)
        empty_db.execute("INSERT INTO symbols_snapshot VALUES ('test', 'TEST', 'Test', 'NASDAQ', 'stock', 'active', 1000000, 'Tech', 'Software', 'US', 'USD', '2024-01-15')")
    ...
    def test_attach_symbols_master_new_dataset(self, empty_db, temp_data_dir):
        ...
        expected_columns = {
            "id", "natural_key", "symbol", "company_name", "exchange", 
            "asset_type", "status", "market_cap", "sector", "industry",
            "country", "currency", "valid_from", "valid_to", "created_at", "as_of"
        }
